...
## RAD NOTES -- WARNING. This code is "legacy", contains older packages (plyr), 
## and methods of programming that are NOT recommended (i.e. attach/detach)
## Use as an example, but do not copy directly. 
